...
Responsible use of space does not rely on any single entity.  Discussions between [responsible parties](https://metro.co.uk/2021/12/30/elon-musk-denies-his-starlink-satellites-are-hogging-space-15839814/) must be based on non-biased data, with the same data being made available to all parties.  The data must also be cryptographically signed, validated, and verified.
...
This decentralized network will be interoperable with current solutions, data can be published and consumed without arbitrary limits.
